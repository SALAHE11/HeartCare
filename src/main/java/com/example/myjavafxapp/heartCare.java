...
public class heartCare extends Application {
    @Override
    public void start(Stage stage) throws IOException {
        ...
        // Load the FXML file
        FXMLLoader fxmlLoader = new FXMLLoader(heartCare.class.getResource("/com/example/myjavafxapp/auth/loginForm.fxml"));
