...
public class PatientRecordsViewController implements Initializable {
    ...
    private void handleViewMedicalRecord(ActionEvent event) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/myjavafxapp/dossierPatient.fxml"));
    ...
    private void handleBackToCalendar(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/myjavafxapp/CalendarView.fxml"));
