...
public class GestionDossierController implements Initializable {
...

            {
                ...
                editButton.setOnAction(event -> {
                    ...
                    try {
                        ...
                        SwitchScene.switchScene(event, "/com/example/myjavafxapp/editerPatient.fxml");
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                });
                ...
                folderButton.setOnAction(event -> {
                    ...
                    try {
                        // Store the selected patient in a shared location or pass as parameter
                        PatientDataHolder.getInstance().setCurrentPatient(patient);
                        SwitchScene.switchScene(event, "/com/example/myjavafxapp/dossierPatient.fxml");
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                });
    ...
    public void addPatientAction(ActionEvent actionEvent) {
        try {
            SwitchScene.switchScene(actionEvent, "/com/example/myjavafxapp/ajouterPatient.fxml");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
