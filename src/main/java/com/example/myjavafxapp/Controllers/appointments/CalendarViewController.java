...
public class CalendarViewController implements Initializable {
    ...
    public void onCreditCard(ActionEvent event) {
        try {
            SwitchScene.switchScene(event, "/com/example/myjavafxapp/payments/GestionPaiment.fxml");
        } catch (IOException e) {
    ...
    public void onFolder(ActionEvent event) {
        try {
            SwitchScene.switchScene(event, "/com/example/myjavafxapp/patients/PatientRecordsView.fxml");
        } catch (IOException e) {
    ...
    public void onGlobalStats(ActionEvent event) {
        try {
            SwitchScene.switchScene(event, "/com/example/myjavafxapp/reports/StatisticsDashboard.fxml");
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void onRepport(ActionEvent event) {
        try {
            SwitchScene.switchScene(event, "/com/example/myjavafxapp/reports/rapportQuotidien.fxml");
        } catch (IOException e) {
    ...
    public void onUsers(ActionEvent event) {
        try {
            SwitchScene.switchScene(event, "/com/example/myjavafxapp/users/Users.fxml");
        } catch (IOException e) {
