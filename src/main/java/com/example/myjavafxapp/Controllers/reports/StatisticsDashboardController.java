package com.example.myjavafxapp.Controllers.reports;
...
import com.example.myjavafxapp.Models.reports.StatisticsManager;
...
public class StatisticsDashboardController implements Initializable {
    ...
    public void handleBackToDashboard(ActionEvent event) {
        navigateTo("/com/example/myjavafxapp/appointments/CalendarView.fxml");
    }
